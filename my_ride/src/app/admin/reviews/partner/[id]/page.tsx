...
try {
    ...
    return (
        <div className='min-h-screen bg-linear-to-br from-gray-100 to-gray-200 pt-16 sm:pt-20'>
            <div className='backdrop-blur-xl bg-white/70 border-b'>
                <div className='max-w-7xl mx-auto px-4 h-16 flex items-center gap-4'>
                    <button className='w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition cursor-pointer' onClick={() => router.back()} title="Go Back">
                        <ArrowLeft size={18} />
                    </button>
