...
export async function POST(req: NextRequest) {
    try {
        ...
        // Print prominently in server logs for instant debugging
        console.log(`\n========================================`);
        ...
        <body>
          <div class="card">
            ...
            <p style="color: #4b5563; font-size: 14px; line-height: 1.5;">
              Hi <strong>${name}</strong>, thank you for joining MY RIDE! Use the one-time verification code below to complete your registration:
            </p>
            <div class="otp-box">
              <p class="otp-code">${otp}</p>
            </div>
            <p style="color: #6b7280; font-size: 13px;">
              ⏱️ This OTP is valid for <strong>10 minutes</strong>. If you did not request this code, please ignore this email.
            </p>
            <div class="footer">
        ...
        try {
            await sendMail(
                normalizedEmail,
                `${otp} is your MY RIDE verification code`,
                emailHtml,
                `Your MY RIDE verification code is: ${otp}. It is valid for 10 minutes.`
            );
        } catch (mailErr) {
